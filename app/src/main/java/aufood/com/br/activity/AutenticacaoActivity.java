...
public class AutenticacaoActivity extends AppCompatActivity {
                        ...
                        autenticacao.createUserWithEmailAndPassword(
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    abrirTelaPosCadastro(tipoUsuario);
                                    ...
                                    try {
                                        ...
                                        erroExcesao = "Por favor, digite um e-mail válido";
    ...
    private void abrirTelaPosCadastro(String tipoUsuario){
        if (tipoUsuario.equals("E")) {//empresa
    ...
    private void inicializaComponentes(){
        ...
        tipoAcesso = findViewById(R.id.swithAcesso);
        tipoUsuario = findViewById(R.id.swithTipoUsuario);
